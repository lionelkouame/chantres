...
use App\Shared\Domain\User\Event\UserActivated;
use App\Shared\Domain\User\UserId;
use PHPUnit\Framework\TestCase;

final class UserActivatedTest extends TestCase
{
    ...
    public function testCarriesOptionalReason(): void
    {
        $event = new UserActivated(
            ...
            'Approuvé après audition',
        );

        self::assertSame('Approuvé après audition', $event->reason());
    }
}
